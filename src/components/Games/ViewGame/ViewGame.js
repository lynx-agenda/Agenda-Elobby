				...
				<article>
					<div className="row">
						...
						<div className="col-12 col-md-4">
							...
							{diary.watching.some(res => res.idApi===id && res.type === game.typeElobby) ? <Button variant="outline-success" className="w-50 me-2" onClick={() => handlerAddClick(false)}>Jugando</Button> : null}{' '}
							{diary.completed.some(res => res.idApi===id && res.type === game.typeElobby) ? <Button variant="outline-primary" className="w-50 me-2" onClick={() => handlerAddClick(false)}>Terminado</Button> : null}{' '}
							{diary.pending.some(res => res.idApi===id && res.type === game.typeElobby) ? <Button variant="outline-info" className="w-50 me-2" onClick={() => handlerAddClick(false)}>Pendiente</Button> : null}{' '}
							{diary.dropped.some(res => res.idApi===id && res.type === game.typeElobby) ? <Button variant="outline-danger" className="w-50 me-2" onClick={() => handlerAddClick(false)}>Descartado</Button> : null}{' '}
