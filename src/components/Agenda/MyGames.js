  ...
  if (loading) {
    ...
    return(
      ...
      <div className="container">
        <div className={watching.some(el => el.typeElobby === 'game') ? "state-section" : "invisible"}>
          <h2>Siguiendo</h2>
            {watching.map((item) => {
              if(item.typeElobby === 'game'){
                return(
        ...
        <div className={pending.some(el => el.typeElobby === 'game') ? "state-section" : "invisible"}>
          <h2>Pendiente</h2>
          {pending.map((item) => {
            if(item.typeElobby === 'game'){
              return(
        ...
        <div className={completed.some(el => el.typeElobby === 'game') ? "state-section" : "invisible"}>
          <h2>Terminado</h2>
          {completed.map((item) => {
            if(item.typeElobby === 'game'){
              return(
        ...
        <div className={dropped.some(el => el.typeElobby === 'game') ? "state-section" : "invisible"}>
          <h2>Abandonado</h2>
          {dropped.map((item) => {
            if(item.typeElobby === 'game'){
              return(
